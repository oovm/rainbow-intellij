...
public class RainIdiomStatementNode extends ASTWrapperPsiElement implements RainIdiomStatement {

  public RainIdiomStatementNode(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public RainIdiomMark getIdiomMark() {
    return findNotNullChildByClass(RainIdiomMark.class);
  }

  @Override
  @NotNull
  public RainIdiomSymbol getIdiomSymbol() {
    return findNotNullChildByClass(RainIdiomSymbol.class);
  }
